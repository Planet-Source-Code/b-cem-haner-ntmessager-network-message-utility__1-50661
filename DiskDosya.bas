Attribute VB_Name = "Disk_Dosya_Islemleri"
Option Explicit
...
'
'   returns true on success
Public Function Execute(ByVal hwnd As Long, s As String, Optional param As Variant, Optional windowstyle As Variant) As Boolean
   Dim i As Long
